...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        MyRunnable myRunnable2 = new MyRunnable(new ReadFilesArithmetic(), 1); // читаем файл
        MyRunnable myRunnable3 = new MyRunnable(new ParserFilesArithmetic(), 10); // парсим файл
